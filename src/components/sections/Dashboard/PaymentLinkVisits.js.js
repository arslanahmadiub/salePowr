...
const SmallFadedLabel = Styled.div`
    ...
    border-bottom-left-radius: ${props => props.selected && props.borderLeftRadius ? "50px" : "0"};
    border-bottom-right-radius: ${props => props.selected && props.borderRightRadius ? "50px" : "0"};
    border-top-right-radius: ${props => props.selected && props.borderRightRadius ? "50px" : "0"};
    border-top-left-radius: ${props => props.selected && props.borderLeftRadius ? "50px" : "0"};
    ...
    border-right: ${props => props.borderRight ? "0.5px solid #979FAA" : "none"};
...
const PaymentLinkVisits = props => {
    ...
    return <Card>
        <Selector>
            <SmallFadedLabel onClick={changeIndex(0)} borderLeftRadius padding={6} selected={index === 0} borderRight>Day</SmallFadedLabel>
            <SmallFadedLabel onClick={changeIndex(1)} padding={6} selected={index === 1} borderRight>Week</SmallFadedLabel>
